...
export const RequireAllPermissions = (
  ...permissions: string[]
): MethodDecorator => SetMetadata(PERMISSIONS_ALL_KEY, permissions);
...
export const RequireAnyPermission = (
  ...permissions: string[]
): MethodDecorator => SetMetadata(PERMISSIONS_ANY_KEY, permissions);
...
export const Platform = (): ClassDecorator & MethodDecorator =>
  SetMetadata(PLATFORM_KEY, true) as unknown as ClassDecorator &
    MethodDecorator;
