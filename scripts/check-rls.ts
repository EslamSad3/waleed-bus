...
const EXCLUDED_TABLES = new Set(['_prisma_migrations', 'governorates', 'markazes', 'localities', 'lines', 'routes', 'stations', 'route_stations', 'vehicle_brands', 'vip_tiers', 'promotions', 'promotion_targets', 'promotion_usages']);
